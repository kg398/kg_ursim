...
import kg_robot_sim as kgrs

class kg_robot():
    def __init__(self, host="127.0.0.1", port=False, ee_port=False, db_host=False, sim_port=False):
        self.port = port
        ...
        self.sim = False
        if sim_port!=False:
            self.sim = kgrs.kg_robot_sim(self, host=host, port=sim_port)
